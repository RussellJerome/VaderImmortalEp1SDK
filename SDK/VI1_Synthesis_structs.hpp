...
struct FSourceEffectChorusSettings
{
	...
	float                                              Spread;                                                   // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FSlateBrush                                 NormalThumbImage;                                         // 0x0008(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 DisabledThumbImage;                                       // 0x0080(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 NormalBarImage;                                           // 0x00F8(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 DisabledBarImage;                                         // 0x0170(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 BackgroundImage;                                          // 0x01E8(0x0078) (Edit, BlueprintVisible)
	float                                              BarThickness;                                             // 0x0260(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FSlateBrush                                 LargeKnob;                                                // 0x0008(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 LargeKnobOverlay;                                         // 0x0080(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 MediumKnob;                                               // 0x00F8(0x0078) (Edit, BlueprintVisible)
	struct FSlateBrush                                 MediumKnobOverlay;                                        // 0x0170(0x0078) (Edit, BlueprintVisible)
	float                                              MinValueAngle;                                            // 0x01E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxValueAngle;                                            // 0x01EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ESynthKnobSize                                     KnobSize;                                                 // 0x01F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
