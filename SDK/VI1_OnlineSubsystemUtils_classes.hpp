...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0508(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0508(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0509(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x050C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0510(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0528(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x052C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x0530(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x0534(0x0004) (ZeroConstructor, Config, IsPlainOldData)
