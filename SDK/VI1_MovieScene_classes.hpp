...
public:
	...
	EMovieSceneCompletionMode                          DefaultCompletionMode;                                    // 0x03A8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bParentContextsAreSignificant;                            // 0x03A9(0x0001) (ZeroConstructor, IsPlainOldData)
