...
public:
	...
	EVirtualKeyboardDismissAction                      VirtualKeyboardDismissAction;                             // 0x03EF(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextJustify>                          Justification;                                            // 0x03F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03F1(0x0003) MISSED OFFSET
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x03F4(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
...
public:
	...
	EVirtualKeyboardDismissAction                      VirtualKeyboardDismissAction;                             // 0x0927(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETextJustify>                          Justification;                                            // 0x0928(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0929(0x0003) MISSED OFFSET
	struct FShapedTextOptions                          ShapedTextOptions;                                        // 0x092C(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0934(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTextChanged;                                            // 0x0938(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTextCommitted;                                          // 0x0948(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	bool                                               SelectAllTextWhenFocused;                                 // 0x0390(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               ClearTextSelectionOnFocusLoss;                            // 0x0391(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               RevertTextOnEscape;                                       // 0x0392(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               ClearKeyboardFocusOnCommit;                               // 0x0393(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               AllowContextMenu;                                         // 0x0394(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EVirtualKeyboardDismissAction                      VirtualKeyboardDismissAction;                             // 0x0395(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	EVirtualKeyboardDismissAction                      VirtualKeyboardDismissAction;                             // 0x0A5A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnAnimationStarted;                                       // 0x03B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAnimationFinished;                                      // 0x03C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UMovieScene*                                 MovieScene;                                               // 0x03D0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TArray<struct FWidgetAnimationBinding>             AnimationBindings;                                        // 0x03D8(0x0010) (ZeroConstructor)
