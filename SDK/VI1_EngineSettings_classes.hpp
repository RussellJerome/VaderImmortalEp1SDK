...
public:
	...
	int                                                VRDebugTextYOffset;                                       // 0x010C(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     ILMColorManagementLUTTextureName;                         // 0x0110(0x0010) (Edit, ZeroConstructor, Config)
	bool                                               bStartInAR;                                               // 0x0120(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bSupportAR;                                               // 0x0121(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowWindowResize;                                       // 0x0122(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowClose;                                              // 0x0123(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowMaximize;                                           // 0x0124(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowMinimize;                                           // 0x0125(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
