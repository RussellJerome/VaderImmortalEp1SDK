...
public:
	...
	TMap<struct FString, struct FLevelSequenceObject>  PossessedObjects;                                         // 0x0458(0x0050) (ZeroConstructor, Deprecated)
	bool                                               GenerateHardRefsFromEventSoftRefs;                        // 0x04A8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x04A9(0x0007) MISSED OFFSET
	TArray<class UObject*>                             ObjectsReferencedByEvents;                                // 0x04B0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	class ULevelSequence*                              AsyncLoadedSequence;                                      // 0x03B0(0x0008) (ZeroConstructor, IsPlainOldData)
