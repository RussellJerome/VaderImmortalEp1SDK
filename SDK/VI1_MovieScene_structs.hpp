...
enum class EMovieSceneCompletionMode : uint8_t
{
	...
	RestoreSlotState               = 2,
	ProjectDefault                 = 3,
	EMovieSceneCompletionMode_MAX  = 4
};
...
{
	struct FGuid                                       Signature;                                                // 0x0000(0x0010) (IsPlainOldData)
	TArray<struct FFloatRange>                         Ranges;                                                   // 0x0010(0x0010) (ZeroConstructor)
	TArray<struct FMovieSceneEvaluationGroup>          Groups;                                                   // 0x0020(0x0010) (ZeroConstructor)
	TArray<struct FMovieSceneEvaluationMetaData>       MetaData;                                                 // 0x0030(0x0010) (ZeroConstructor)
};
...
struct FMovieSceneEvaluationTemplate
{
	...
	struct FGuid                                       SequenceSignature;                                        // 0x0180(0x0010) (IsPlainOldData)
