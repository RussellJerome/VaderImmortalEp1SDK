...
struct ABP_HalfMarksmanH_C_UserConstructionScript_Params
{
};

// Function BP_HalfMarksmanH.BP_HalfMarksmanH_C.ReceiveHit
struct ABP_HalfMarksmanH_C_ReceiveHit_Params
{
...
struct ABP_HalfMarksmanH_C_ReceiveBeginPlay_Params
{
};

// Function BP_HalfMarksmanH.BP_HalfMarksmanH_C.ReceiveTick
struct ABP_HalfMarksmanH_C_ReceiveTick_Params
{
	float*                                             DeltaSeconds;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_HalfMarksmanH.BP_HalfMarksmanH_C.ExecuteUbergraph_BP_HalfMarksmanH
struct ABP_HalfMarksmanH_C_ExecuteUbergraph_BP_HalfMarksmanH_Params
{
