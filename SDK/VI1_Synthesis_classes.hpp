...
{
public:
	int                                                VoiceCount;                                               // 0x06B0(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6DC];                                     // 0x06B4(0x06DC) MISSED OFFSET
...
public:
	...
	struct FSourceEffectChorusSettings                 Settings;                                                 // 0x007C(0x0014) (Edit, BlueprintVisible)
...
public:
	unsigned char                                      UnknownData00[0x34];                                      // 0x0040(0x0034) MISSED OFFSET
	struct FSourceEffectRingModulationSettings         Settings;                                                 // 0x0074(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly)
...
public:
	...
	struct FSynth2DSliderStyle                         WidgetStyle;                                              // 0x0128(0x0268) (Edit, BlueprintVisible)
	struct FLinearColor                                SliderHandleColor;                                        // 0x0390(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	bool                                               IndentHandle;                                             // 0x03A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               Locked;                                                   // 0x03A1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x03A2(0x0002) MISSED OFFSET
	float                                              StepSize;                                                 // 0x03A4(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               IsFocusable;                                              // 0x03A8(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    OnValueChangedX;                                          // 0x03F0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnValueChangedY;                                          // 0x0400(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	unsigned char                                      UnknownData00[0x380];                                     // 0x06B0(0x0380) MISSED OFFSET
...
// 0x0140 (0x07F0 - 0x06B0)
class USynthSamplePlayer : public USynthComponent
{
public:
	class USoundWave*                                  SoundWave;                                                // 0x06B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnSampleLoaded;                                           // 0x06B8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSamplePlaybackProgress;                                 // 0x06C8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0x118];                                     // 0x06D8(0x0118) MISSED OFFSET
...
public:
	...
	struct FSynthKnobStyle                             WidgetStyle;                                              // 0x0158(0x01F8) (Edit, BlueprintVisible)
	bool                                               Locked;                                                   // 0x0350(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               IsFocusable;                                              // 0x0351(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x6];                                       // 0x0352(0x0006) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnMouseCaptureBegin;                                      // 0x0358(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnMouseCaptureEnd;                                        // 0x0368(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnControllerCaptureBegin;                                 // 0x0378(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnControllerCaptureEnd;                                   // 0x0388(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnValueChanged;                                           // 0x0398(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
