...
// Enum Engine.EHandTouch
enum class EHandTouch : uint8_t
{
	EHT_TouchStart                 = 0,
	EHT_Touching                   = 1,
	EHT_TouchEnd                   = 2,
...
// Enum Engine.ECastingViewportCompositionMethod
enum class ECastingViewportCompositionMethod : uint8_t
{
	MultiView                      = 0,
	DirectComposition              = 1,
	ECastingViewportCompositionMethod_MAX = 2
};


// Enum Engine.ECastingLayer
enum class ECastingLayer : uint8_t
{
	Full                           = 0,
	Background                     = 1,
	Foreground                     = 2,
...
enum class EViewModeIndex : uint8_t
{
	...
	VMI_LitDrawCallColoration      = 24,
	VMI_UnlitDrawCallColoration    = 25,
	VMI_Max                        = 26,
	VMI_Unknown                    = 27
};
...
// Enum Engine.ENTMaterialExpressionSantaCruz
enum class ENTMaterialExpressionSantaCruz : uint8_t
{
	MESC_SantaCruz                 = 0,
	MESC_Count                     = 1,
	MESC_MAX                       = 2
...
enum class EMaterialProperty : uint8_t
{
	...
	MP_DiffColor                   = 27,
	MP_DiffEdgeBrightnessColor     = 28,
	MP_DiffEdgeBrightnessProfile   = 29,
	MP_DiffRoughness               = 30,
	MP_SpecColor                   = 31,
	MP_SpecColor90                 = 32,
	MP_SpecFresnelProfile          = 33,
	MP_Spec2Color                  = 34,
	MP_Spec2Color90                = 35,
	MP_Spec2Roughness              = 36,
	MP_Spec2FresnelProfile         = 37,
	MP_SpecRoughnessAniso          = 38,
	MP_Spec2RoughnessAniso         = 39,
	MP_SpecAnisoRotation           = 40,
	MP_LightmapModifier            = 41,
...
enum class ETextureGroup : uint8_t
{
	...
	TEXTUREGROUP_World_Atlas       = 30,
	TEXTUREGROUP_WorldNormalMap_Atlas = 31,
	TEXTUREGROUP_MRAMasks_Atlas    = 32,
	TEXTUREGROUP_EnvironmentD      = 33,
	TEXTUREGROUP_EnvironmentN      = 34,
	TEXTUREGROUP_EnvironmentMRA    = 35,
	TEXTUREGROUP_EnvironmentAO     = 36,
	TEXTUREGROUP_EffectsHiRes      = 37,
	TEXTUREGROUP_MAX               = 38
};
...
struct FLightingChannels
{
	...
	unsigned char                                      bChannel3 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bChannel4 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bChannel5 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bChannel6 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bChannel7 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
};

// ScriptStruct Engine.ReflectionCaptureChannels
// 0x0001
struct FReflectionCaptureChannels
{
	unsigned char                                      bChannel0 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bChannel1 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bChannel2 : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      bUseLightmassTransform : 1;                               // 0x0000(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	...
	struct FTransform                                  LightmassTransform;                                       // 0x0020(0x0030) (Edit, IsPlainOldData)
};
...
struct FMaterialInstanceBasePropertyOverrides
{
	...
	bool                                               bOverride_SantaCruzBlendMode;                             // 0x0002(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_SantaCruzFullyRough;                            // 0x0003(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_EnableSceneDepthOnSantaCruz;                    // 0x0004(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_ShadingModel;                                   // 0x0005(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_DitheredLODTransition;                          // 0x0006(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_CastDynamicShadowAsMasked;                      // 0x0007(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverride_TwoSided;                                       // 0x0008(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	float                                              OpacityMaskClipValue;                                     // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlendMode>                            BlendMode;                                                // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBlendMode>                            SantaCruzBlendMode;                                       // 0x0011(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EMaterialShadingModel>                 ShadingModel;                                             // 0x0012(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0013(0x0001) MISSED OFFSET
	unsigned char                                      TwoSided : 1;                                             // 0x0014(0x0001) (Edit)
	unsigned char                                      DitheredLODTransition : 1;                                // 0x0014(0x0001) (Edit)
	unsigned char                                      bCastDynamicShadowAsMasked : 1;                           // 0x0014(0x0001) (Edit)
	unsigned char                                      bSantaCruzFullyRough : 1;                                 // 0x0014(0x0001) (Edit)
	unsigned char                                      bEnableSceneDepthOnSantaCruz : 1;                         // 0x0014(0x0001) (Edit)
	unsigned char                                      bForceSantaCruzOnMaterialSwitches : 1;                    // 0x0014(0x0001) (Edit)
	unsigned char                                      bForceMobileVertexFog : 1;                                // 0x0014(0x0001) (Edit)
	unsigned char                                      bSantaCruzNonMetal : 1;                                   // 0x0014(0x0001) (Edit)
...
{
	uint64_t                                           PropertyConnectedBitmask;                                 // 0x0030(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData01[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	struct FMeshProxySettings                          ProxySetting;                                             // 0x000C(0x00BC) (Edit)
	struct FMeshMergingSettings                        MergeSetting;                                             // 0x00C8(0x00BC) (Edit)
	...
	bool                                               bOnlyGenerateClustersForVolumes;                          // 0x0190(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x530];                                     // 0x0000(0x0530) MISSED OFFSET
};
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData02[0xC0];                                      // 0x0098(0x00C0) MISSED OFFSET
	TArray<int>                                        NextSections;                                             // 0x0158(0x0010) (ZeroConstructor)
	TArray<int>                                        PrevSections;                                             // 0x0168(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0178(0x0010) MISSED OFFSET
	TArray<struct FAnimNotifyEvent>                    ActiveStateBranchingPoints;                               // 0x0188(0x0010) (ZeroConstructor, Transient)
	float                                              Position;                                                 // 0x0198(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x019C(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FAlphaBlend                                 Blend;                                                    // 0x01A0(0x0038) (Transient)
	struct FAlphaBlend                                 BlendOut;                                                 // 0x01D8(0x0038) (Transient)
	unsigned char                                      UnknownData04[0x20];                                      // 0x0210(0x0020) MISSED OFFSET
	int                                                DisableRootMotionCount;                                   // 0x0230(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	float                                              PlayRateBasis;                                            // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// ScriptStruct Engine.AnimSequencePlatformCompressedData
// 0x0010
struct FAnimSequencePlatformCompressedData
{
	struct FName                                       PlatformInfoName;                                         // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	class UAnimSequence*                               AnimSequenceWithPlatformSpecificCompressedData;           // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x180];                                     // 0x0530(0x0180) MISSED OFFSET
};
...
struct FWorldContext
{
	...
	TArray<class UCastingViewportClient*>              CastingViewports;                                         // 0x0240(0x0010) (ZeroConstructor)
	class UGameInstance*                               OwningGameInstance;                                       // 0x0250(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNamedNetDriver>                     ActiveNetDrivers;                                         // 0x0258(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData03[0x38];                                      // 0x0268(0x0038) MISSED OFFSET
};
...
struct FStaticMeshSourceModel
{
	...
	float                                              ScreenSize;                                               // 0x0058(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
};
