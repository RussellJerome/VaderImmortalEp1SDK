...
{
public:
	TArray<struct FSoundVariation>                     Variations;                                               // 0x00B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class USoundWave*                                  SoundWave;                                                // 0x00C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
