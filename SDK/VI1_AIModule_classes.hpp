...
public:
	...
	class UEnvQuery*                                   QueryTemplate;                                            // 0x0728(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0730(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0740(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x0750(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x0754(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x0758(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0759(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x075C(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x075C(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x075C(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x075C(0x0001) (Edit)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x075C(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x075D(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x0760(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x0761(0x0007) MISSED OFFSET
	struct FNavAgentProperties                         NavAgentProperties;                                       // 0x0768(0x0020) (Edit)
	unsigned char                                      UnknownData04[0x28];                                      // 0x0788(0x0028) MISSED OFFSET
