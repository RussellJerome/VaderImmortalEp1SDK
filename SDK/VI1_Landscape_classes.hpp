...
public:
	...
	int                                                StaticLightingLOD;                                        // 0x035C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UPhysicalMaterial*                           DefaultPhysMaterial;                                      // 0x0360(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UMaterialInterface*                          LandscapeMaterial;                                        // 0x0370(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          LandscapeHoleMaterial;                                    // 0x0378(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              NegativeZBoundsExtension;                                 // 0x0380(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PositiveZBoundsExtension;                                 // 0x0384(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<class ULandscapeComponent*>                 LandscapeComponents;                                      // 0x0388(0x0010) (ExportObject, ZeroConstructor)
	TArray<class ULandscapeHeightfieldCollisionComponent*> CollisionComponents;                                      // 0x0398(0x0010) (ExportObject, ZeroConstructor)
	TArray<class UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;                                        // 0x03A8(0x0010) (ExportObject, ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData03[0x64];                                      // 0x03B8(0x0064) MISSED OFFSET
	bool                                               bHasLandscapeGrass;                                       // 0x041C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x041D(0x0003) MISSED OFFSET
	float                                              StaticLightingResolution;                                 // 0x0420(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCastStaticShadow : 1;                                    // 0x0424(0x0001) (Edit)
	unsigned char                                      bCastShadowAsTwoSided : 1;                                // 0x0424(0x0001) (Edit)
	unsigned char                                      bCastFarShadow : 1;                                       // 0x0424(0x0001) (Edit)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0425(0x0003) MISSED OFFSET
	struct FLightingChannels                           LightingChannels;                                         // 0x0428(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0429(0x0003) MISSED OFFSET
	unsigned char                                      bUseMaterialPositionOffsetInStaticLighting : 1;           // 0x042C(0x0001) (Edit)
	unsigned char                                      bRenderCustomDepth : 1;                                   // 0x042C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      UnknownData07[0x3];                                       // 0x042D(0x0003) MISSED OFFSET
	int                                                CustomDepthStencilValue;                                  // 0x0430(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0xC];                                       // 0x0434(0x000C) MISSED OFFSET
	struct FLightmassPrimitiveSettings                 LightmassSettings;                                        // 0x0440(0x0050) (Edit)
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x04A0(0x0200) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bGenerateOverlapEvents : 1;                               // 0x06A0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bBakeMaterialPositionOffsetIntoCollision : 1;             // 0x06A0(0x0001) (Edit)
	unsigned char                                      UnknownData10[0x3];                                       // 0x06A1(0x0003) MISSED OFFSET
	int                                                ComponentSizeQuads;                                       // 0x06A4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x06A8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x06AC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUsedForNavigation : 1;                                   // 0x06B0(0x0001) (Edit)
	unsigned char                                      UnknownData11[0x3];                                       // 0x06B1(0x0003) MISSED OFFSET
	bool                                               bUseDynamicMaterialInstance;                              // 0x06B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x06B5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x06B6(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0xA9];                                      // 0x06B7(0x00A9) MISSED OFFSET
...
public:
	...
	TArray<class UMaterialInstanceDynamic*>            MaterialInstancesDynamic;                                 // 0x06B8(0x0010) (ZeroConstructor, Transient)
	...
	unsigned char                                      UnknownData04[0x30];                                      // 0x07E0(0x0030) MISSED OFFSET
...
{
public:
	struct FGuid                                       LandscapeGuid;                                            // 0x0750(0x0010) (IsPlainOldData)
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x0760(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0770(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0771(0x000F) MISSED OFFSET
