...
{
public:
	EMediaSoundChannels                                Channels;                                                 // 0x06B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UMediaPlayer*                                MediaPlayer;                                              // 0x06B8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FLinearColor                                ClearColor;                                               // 0x00C4(0x0010) (Edit, BlueprintVisible, IsPlainOldData)
