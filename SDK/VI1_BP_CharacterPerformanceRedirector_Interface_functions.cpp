...
void UBP_CharacterPerformanceRedirector_Interface_C::RequestSetSequencerBlendWeight(float Weight)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_CharacterPerformanceRedirector_Interface.BP_CharacterPerformanceRedirector_Interface_C.RequestSetSequencerBlendWeight");

	UBP_CharacterPerformanceRedirector_Interface_C_RequestSetSequencerBlendWeight_Params params;
...
void UBP_CharacterPerformanceRedirector_Interface_C::SetAnimationReferences(const struct FCharacterPerformanceLookAtStruct& Settings)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_CharacterPerformanceRedirector_Interface.BP_CharacterPerformanceRedirector_Interface_C.SetAnimationReferences");

	UBP_CharacterPerformanceRedirector_Interface_C_SetAnimationReferences_Params params;
...
void UBP_CharacterPerformanceRedirector_Interface_C::Disable_LookAt(bool Enable, float TransitionDuration, const struct FVector2D& DistanceLimits, float HeadLookAtStrength, float EyeLookAtStrength, float BodyLookAtStrength)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_CharacterPerformanceRedirector_Interface.BP_CharacterPerformanceRedirector_Interface_C.Disable LookAt");

	UBP_CharacterPerformanceRedirector_Interface_C_Disable_LookAt_Params params;
