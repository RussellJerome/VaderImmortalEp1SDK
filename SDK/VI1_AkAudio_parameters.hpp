...
struct UAkAudioBank_NTPendingAynchronousLoads_Params
{
...
struct UNTAKComponentProviderIF_GetComponent_Params
{
	struct FName                                       AttachPointName;                                          // (Parm, ZeroConstructor, IsPlainOldData)
	class UAkComponent*                                ReturnValue;                                              // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};
...
struct UNTAkGameplayStatics_SetOnAllComponentsSwitch_Params
{
	class AActor*                                      Actor;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
	struct FString                                     SwitchGroup;                                              // (Parm, ZeroConstructor)
	struct FString                                     SwitchState;                                              // (Parm, ZeroConstructor)
...
struct UNTAkGameplayStatics_SetOnAllComponentsRTPC_Params
{
	class AActor*                                      Actor;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
	struct FString                                     RTPC;                                                     // (Parm, ZeroConstructor)
	float                                              Value;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNTAkGameplayStatics_PlayInEditor_Params
{
};

// Function AkAudio.NTAkGameplayStatics.NTWaitForEventToBePosted
struct UNTAkGameplayStatics_NTWaitForEventToBePosted_Params
{
	class UObject*                                     WorldContextObject;                                       // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNTAkGameplayStatics_NTWaitForEvent_Params
{
	class UObject*                                     WorldContextObject;                                       // (Parm, ZeroConstructor, IsPlainOldData)
	struct FNTPlayingEvent                             PlayingEvent;                                             // (Parm)
	bool                                               ProtectAgainstMultipleCalls;                              // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNTAkGameplayStatics_NTStopPlayingEvent_Params
{
	struct FNTPlayingEvent                             PlayingEvent;                                             // (Parm)
...
struct UNTAkGameplayStatics_NTPostEventOnAKComponent_Params
{
	class UAkAudioEvent*                               AkEvent;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNTAkGameplayStatics_NTPostEvent_Params
{
	class UAkAudioEvent*                               AkEvent;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
	class AActor*                                      Actor;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
	bool                                               bStopWhenAttachedToDestroyed;                             // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNTAkGameplayStatics_NTGetAKComponent_Params
{
	struct FNTPlayingEvent                             PlayingEvent;                                             // (Parm)
	class UAkComponent*                                ReturnValue;                                              // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};
...
struct UNTAkGameplayStatics_NTDelay_Params
{
	class UObject*                                     WorldContextObject;                                       // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNTAkGameplayStatics_NTCheckEventIsPlaying_Params
{
	struct FNTPlayingEvent                             PlayingEvent;                                             // (Parm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
