...
void UProceduralMeshComponent::UpdateMeshSection_LinearColor(int LODIndex, int SectionIndex, TArray<struct FVector> Vertices, TArray<struct FVector> Normals, TArray<struct FVector2D> UV0, TArray<struct FLinearColor> VertexColors, TArray<struct FProcMeshTangent> Tangents)
{
...
void UProceduralMeshComponent::UpdateMeshSection(int LODIndex, int SectionIndex, TArray<struct FVector> Vertices, TArray<struct FVector> Normals, TArray<struct FVector2D> UV0, TArray<struct FColor> VertexColors, TArray<struct FProcMeshTangent> Tangents)
{
...
void UProceduralMeshComponent::SetMeshSectionVisible(int LODIndex, int SectionIndex, bool bNewVisibility)
{
...
bool UProceduralMeshComponent::IsMeshSectionVisible(int LODIndex, int SectionIndex)
{
...
int UProceduralMeshComponent::GetNumSections(int LODIndex)
{
...
// Function ProceduralMeshComponent.ProceduralMeshComponent.GetNumLODs
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UProceduralMeshComponent::GetNumLODs()
{
	static auto fn = UObject::FindObject<UFunction>("Function ProceduralMeshComponent.ProceduralMeshComponent.GetNumLODs");

	UProceduralMeshComponent_GetNumLODs_Params params;
...
void UProceduralMeshComponent::CreateMeshSection_LinearColor(int LODIndex, int SectionIndex, TArray<struct FVector> Vertices, TArray<int> Triangles, TArray<struct FVector> Normals, TArray<struct FVector2D> UV0, TArray<struct FLinearColor> VertexColors, TArray<struct FProcMeshTangent> Tangents, int MaterialIndex, bool bCreateCollision)
{
...
void UProceduralMeshComponent::CreateMeshSection(int LODIndex, int SectionIndex, TArray<struct FVector> Vertices, TArray<int> Triangles, TArray<struct FVector> Normals, TArray<struct FVector2D> UV0, TArray<struct FColor> VertexColors, TArray<struct FProcMeshTangent> Tangents, int MaterialIndex, bool bCreateCollision)
{
...
void UProceduralMeshComponent::ClearMeshSection(int LODIndex, int SectionIndex)
{
...
// float                          ColorDistanceFromEdge          (Parm, ZeroConstructor, IsPlainOldData)
...
void UKismetProceduralMeshLibrary::STATIC_SliceProceduralMesh(class UProceduralMeshComponent* InProcMesh, const struct FVector& PlanePosition, const struct FVector& PlaneNormal, bool bCreateOtherHalf, EProcMeshSliceCapOption CapOption, class UMaterialInterface* CapMaterial, bool bColorCutEdgeWhite, float ColorDistanceFromEdge, class UProceduralMeshComponent** OutOtherHalfProcMesh)
{
	...
	params.ColorDistanceFromEdge = ColorDistanceFromEdge;
