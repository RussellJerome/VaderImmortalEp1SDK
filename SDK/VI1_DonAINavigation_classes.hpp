...
// 0x4818 (0x4B30 - 0x0318)
class ADonNavigationManager : public AActor
{
public:
	unsigned char                                      UnknownData00[0x1F4];                                     // 0x0318(0x01F4) MISSED OFFSET
	bool                                               bIsUnbound;                                               // 0x050C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x050D(0x0003) MISSED OFFSET
	class USceneComponent*                             SceneComponent;                                           // 0x0510(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBillboardComponent*                         Billboard;                                                // 0x0518(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0520(0x0010) MISSED OFFSET
	float                                              VoxelSize;                                                // 0x0530(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                XGridSize;                                                // 0x0534(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                YGridSize;                                                // 0x0538(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                ZGridSize;                                                // 0x053C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<TEnumAsByte<ECollisionChannel>>             ObstacleQueryChannels;                                    // 0x0540(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<class AActor*>                              ActorsToIgnoreForCollision;                               // 0x0550(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<float>                                      AutoCorrectionGuessList;                                  // 0x0560(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              UnrealPhyxPenetrationDepth;                               // 0x0570(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               PerformCollisionChecksOnStartup;                          // 0x0574(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bMultiThreadingEnabled;                                   // 0x0575(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0576(0x0002) MISSED OFFSET
	int                                                MaxPathSolverIterationsPerTick;                           // 0x0578(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxCollisionSolverIterationsPerTick;                      // 0x057C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxPathSolverIterationsOnThread;                          // 0x0580(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxCollisionSolverIterationsOnThread;                     // 0x0584(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxPathSolverIterationsPerTick_Unbound;                   // 0x0588(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxCollisionSolverIterationsPerTick_Unbound;              // 0x058C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxPathSolverIterationsOnThread_Unbound;                  // 0x0590(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxCollisionSolverIterationsOnThread_Unbound;             // 0x0594(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBoxComponent*                               WorldBoundaryVisualizer;                                  // 0x0598(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               bDisplayWorldBoundary;                                    // 0x05A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDisplayWorldBoundaryInGame;                              // 0x05A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x05A2(0x0002) MISSED OFFSET
	float                                              DebugVoxelsLineThickness;                                 // 0x05A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bRunDebugValidationsForDynamicCollisions;                 // 0x05A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x43E7];                                    // 0x05A9(0x43E7) MISSED OFFSET
	...
	unsigned char                                      UnknownData07[0x50];                                      // 0x49E0(0x0050) UNKNOWN PROPERTY: SetProperty DonAINavigation.DonNavigationManager.ActiveCollisionTaskOwners
	unsigned char                                      UnknownData08[0x100];                                     // 0x4A30(0x0100) MISSED OFFSET
	...
	void ViewWorldOccupancy(class AActor* Actor, class UPrimitiveComponent* Mesh);
	...
	void RemoveMeshFromCells(class AActor* Actor, class UPrimitiveComponent* Mesh);
	void RefreshWorldOccupancy(class AActor* Actor, class UPrimitiveComponent* Mesh, bool rebuildProfile);
	void RebuildCollisionProfile(class AActor* Actor, class UPrimitiveComponent* Mesh);
	...
	void Debug_DrawAllVolumes(float LineThickness, bool Filter);
	...
	void BruteForceVisualiser(bool showStatic, bool showDyanimc, bool showPath);
	void AddMeshToCells(class AActor* Actor, class UPrimitiveComponent* Mesh);
